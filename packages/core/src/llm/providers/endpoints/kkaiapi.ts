 ...
 *
 * - 官网：https://yunwu.ai/
 * - API 文档：https://yunwu.ai/docs
 * - 模型列表：https://yunwu.ai/models
 * - 价格页：https://yunwu.ai/pricing
 *
...
export const KKAIAPI: InkosEndpoint = {
  ...
  modelsBaseUrl: "https://yunwu.ai/v1",
  ...
  models: [
    ...
    // Hide until yunwu exposes a verified MiniMax chat route/model id.
